...
- **Moderator zählt nicht zum Spielerlimit**: Limit-Check beim Beitreten, Lobby-Zähler und Start-Button schließen den Mod jetzt korrekt aus
- **Mod-Review springt nicht an**: Wortgeber-Zähler (`givers`) schloss den Moderator nicht aus – die Runde blieb hängen sobald alle Spieler ihren Hinweis eingegeben hatten. Mod wird nun korrekt herausgefiltert.
...
- **Tippgeber verlässt Clue-Phase**: sein Hinweis wird gelöscht und der Zähler neu geprüft – die Gruppe wartet nicht mehr auf ihn
