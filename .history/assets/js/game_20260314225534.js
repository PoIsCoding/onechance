...
// ── iOS Audio-Unlock ──
// iOS blockiert Audio bis zur ersten Nutzer-Interaktion (Tap/Click).
// Wir laden alle Sounds beim ersten Touch vor und spielen sie stumm ab,
// damit spätere Aufrufe (auch aus Timern) funktionieren.
...
function initFirebase() {
  try {
    ...
    // Anonymen Login durchführen damit Firebase-Regeln greifen.
    // Das Spiel nutzt eigene UIDs (localStorage), Firebase Auth nur für
    // die Zugriffskontrolle auf die Datenbank.
    firebase
      .auth()
      .signInAnonymously()
      .then(() => log("Firebase: Anonymer Login OK"))
      .catch((e) =>
        log("Firebase: Anonymer Login fehlgeschlagen –", e.message),
      );
